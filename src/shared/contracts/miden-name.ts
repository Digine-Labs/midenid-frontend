export const MIDEN_NAME_CONTRACT_CODE = `use miden::protocol::active_account
...
# Storage Slots
const INIT_FLAG_SLOT = word("naming::init_flag")
const OWNER_SLOT = word("naming::owner")
const PRICES_SLOT = word("naming::prices") # domain prices map([0, letter_count, payment_token_prefix, payment_token_suffix] -> [PRICE])
const ACCOUNT_ID_TO_DOMAIN_SLOT = word("naming::account_to_domain")
const DOMAIN_TO_ACCOUNT_ID_SLOT = word("naming::domain_to_account")
const DOMAIN_TO_OWNER_SLOT = word("naming::domain_to_owner")
const REF_RATE_SLOT = word("naming::ref_rate")
const REF_TOTAL_REVENUE_SLOT = word("naming::ref_total_revenue")
const REF_CLAIMED_REVENUE_SLOT = word("naming::ref_claimed_revenue")
const DOMAIN_COUNT_SLOT = word("naming::domain_count")
...
# Inputs: [TOKEN]
pub proc claim_referral_earnings
    nop
    # TODO
end
...
# Input: [OWNER]
pub proc init
    push.INIT_FLAG_SLOT[0..2] exec.active_account::get_item drop drop drop
    assertz.err=ERR_ALREADY_INITIALIZED
    # [OWNER]
    push.OWNER_SLOT[0..2] exec.native_account::set_item dropw
    # []
    push.1.0.0.0 push.INIT_FLAG_SLOT[0..2] exec.native_account::set_item dropw
end

# Nonsense function just to init contract on chain
pub proc init_on_chain
    push.1.0.0.0 push.ONCHAIN_INIT_SLOT[0..2] exec.native_account::set_item dropw
end
...
# Input: [NEW_OWNER]
# Output: []
pub proc update_registry_owner
...
pub proc claim_protocol_revenue
    mem_storew_be.MEM_PAYMENT_TOKEN dropw
...
proc _clear_domain_mapping
    ...
    # [DOMAIN]
    push.DOMAIN_TO_ACCOUNT_ID_SLOT[0..2] exec.active_account::get_map_item
    # [ACCOUNT]
    padw swapw
    # [ACCOUNT, ZERO]
    push.ACCOUNT_ID_TO_DOMAIN_SLOT[0..2] exec.native_account::set_map_item dropw
    # []
    padw mem_loadw_be.MEM_DOMAIN
    # [DOMAIN]
    padw swapw
    # [DOMAIN, ZERO]
    push.DOMAIN_TO_ACCOUNT_ID_SLOT[0..2] exec.native_account::set_map_item dropw
    # []
end
...
proc _increase_total_revenue
    padw mem_loadw_be.MEM_PAYMENT_TOKEN
    push.TOTAL_REVENUE_SLOT[0..2] exec.active_account::get_map_item drop drop drop
    # [total_amount, amt]
    add push.0.0.0
    # [FINAL_AMT]
    padw mem_loadw_be.MEM_PAYMENT_TOKEN
    # [PAYMENT_TOKEN, FINAL_AMT]
    push.TOTAL_REVENUE_SLOT[0..2] exec.native_account::set_map_item dropw
    # []
end
...
proc _update_domain_map
    ...
    # [ACCOUNT, ACCOUNT]
    padw mem_loadw_be.MEM_DOMAIN
    push.DOMAIN_TO_ACCOUNT_ID_SLOT[0..2]
    exec.native_account::set_map_item dropw
    # [ACCOUNT]
    padw mem_loadw_be.MEM_DOMAIN swapw
    # [ACCOUNT, DOMAIN]
    push.ACCOUNT_ID_TO_DOMAIN_SLOT[0..2]
    exec.native_account::set_map_item dropw
    # []
end
...
proc _increase_domain_count
    push.DOMAIN_COUNT_SLOT[0..2]
    exec.active_account::get_item drop drop drop
    # [total_supply]
    add.1 push.0.0.0
    # [0, 0, 0, total_supply + 1]
    push.DOMAIN_COUNT_SLOT[0..2] exec.native_account::set_item dropw
end
