export const MIDEN_ID_CONTRACT_ADDRESS = "0xd7f663d7a35851406ad6295a3dad60";
export const MIDEN_FAUCET_CONTRACT_ADDRESS = "0x300d81593c4e7e2054c497c114b9e5";
...
export.init
    ...
    # account::set_item stores stack positions in REVERSE: [index, V1, V2, V3, V4] → Word[V4, V3, V2, V1]
